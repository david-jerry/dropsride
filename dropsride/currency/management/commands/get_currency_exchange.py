...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        Currency.objects.get_or_create(
            code="USD", defaults={"symbol": "$", "price": Decimal(1.00)}
        )

        url = str(settings.CURRENCY_EXCHANGE_URL)
        ...
        headers = {
            ...
            "x-rapidapi-key": str(settings.CURRENCY_EXCHANGE_API),
        }
        ...
        if ng_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="NGN", defaults={"symbol": "₦", "price": Decimal(ng_rate)}
            )
        ...
        if eu_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="EUR", defaults={"symbol": "€", "price": Decimal(eu_rate)}
            )
        ...
        if gb_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="GBP", defaults={"symbol": "£", "price": Decimal(gb_rate)}
            )
        ...
        if cn_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="CNY", defaults={"symbol": "¥", "price": Decimal(cn_rate)}
            )
        ...
        if jp_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="JPY", defaults={"symbol": "¥", "price": Decimal(jp_rate)}
            )
        ...
        if au_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="AUD", defaults={"symbol": "$", "price": Decimal(au_rate)}
            )
        ...
        if ca_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="CAD", defaults={"symbol": "$", "price": Decimal(ca_rate)}
            )
        ...
        if ch_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="CHF", defaults={"symbol": "CHF", "price": Decimal(ch_rate)}
            )
        ...
        if dk_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="DKK", defaults={"symbol": "kr", "price": Decimal(dk_rate)}
            )
        ...
        if se_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="SEK", defaults={"symbol": "kr", "price": Decimal(se_rate)}
            )
        ...
        if za_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="ZAR", defaults={"symbol": "R", "price": Decimal(za_rate)}
            )
        ...
        if ae_res.status_code == 200:
            ...
            Currency.objects.update_or_create(
                code="AED", defaults={"symbol": "د.إ", "price": Decimal(ae_rate)}
            )
