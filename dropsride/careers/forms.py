...
class CareersForm(ModelForm):
    ...
    def clean_summary(self):
        ...
        if data == "":
            ...
            raise forms.ValidationError("News Summary must be at least 25 characters long.")
        return data
    ...
    def clean_location(self):
        ...
        if len(data) < 1:
            raise forms.ValidationError("There must be a location for applicants to work in")
        return data
