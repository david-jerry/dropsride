...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="mwVWVLevIwJKvThhrhs7AkshAQOsIRnRE98BfitsLNXqsYeJgq8AuqAblMYv7MT9",
)
...
EMAIL_FROM = "Dropsride <noreply@dropsride.com>"
...
# RECAPTCHA_DOMAIN = env('GOOGLE_RECAPTCHA_DOMAIN')
